...
//        }
    ...
    public FillTemplate getFillTemplate() {
        return null; /*FillTemplate.valueOf(plugin.getHubConfig().getSelectorFiller());*/
    }
...
//        @Override
//        public ItemStack getItem(Player player) {
//            ServerInfo server = ServerInfo.getServerInfo("builds");
//            int players = server.getOnlinePlayers();
//
